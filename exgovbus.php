...
<body>
    ...
    <h1 style="
    MARGIN-LEFT:  50px;
    color: blue;">PUBLIC_BUS</h1>
        </div>
    <table class="table" style="border-spacing:75px 30px;text-algin:center;box-shadow:none;border-radius:30px 22px;font:message-box;">
