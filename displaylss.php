...
<html>
    ...
    <body>
        ...
        <button style="margin:12px 10px;
            ...
            box-shadow:10px 10px 10px -1px rgba(10,99,169,0.16),-10px -10px 10px -1px rgba(269,267,269,0.70);"><a href="datain1.php">ADD DATA</a></button>
             <button style="margin:12px 10px;
            ...
            if($result){
                while($row=mysqli_fetch_assoc($result)){
                     ...
                     <td>'.$sendofftime.'</td>
                     <td>'.$reachedtime.'</td>
                     <td><button><a href="update1.php? updateid='.$id.'" style="color:darkblue">UPDATE</a></button>
            <button><a href="delete1.php?
