...
include 'connect.php';
$id=$_GET['updateid'];
$sql="SELECT* FROM lssbus WHERE id=$id";
...
if(isset($_POST['submit'])){
    ...
    $sql="UPDATE lssbus SET id=$id,busname='$busname',sendoff='$sendoff',reach='$reach',sendofftime='$sendofftime',reachedtime='$reachedtime'
    WHERE id=$id";
    $result=mysqli_query($con,$sql);
    if($result){
